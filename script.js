...
// 👉 FORCE portfolio content visible immediately on mobile
if (isMobile) {
  document.querySelectorAll('#portfolio [data-animate]').forEach(function (el) {
...
// 👉 Observe everything EXCEPT portfolio on mobile
animateEls.forEach(function (el) {
  if (isMobile && el.closest('#portfolio')) return;
  observer.observe(el);
});
